...
script_dir_fig_4 = os.path.join(os.path.split(script_dir)[0], "fig_3")
script_dir_suppl = script_dir + "_supplementary"
...
for i in range(3):
    ...
    x_intermitent,y_intermitent = np.load(os.path.join(script_dir_suppl, f"opt_intermitent_{i}.npy"))
    ...
    axes.scatter(x_intermitent, y_intermitent, color = color_rho[i], s=300, linewidth=linewidth*.75, marker='s', facecolors="none")
    axes.scatter(x_math, y_math, color = color_rho[i], s=150, linewidth=linewidth)
