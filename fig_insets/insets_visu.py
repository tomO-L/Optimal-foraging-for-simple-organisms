...
for i in range(3):
    ...
    rho_3 = np.concatenate((rho_3[:7000],rho_3))
...
axes.fill_between(np.linspace(0,len(rho_3)-1,len(rho_3)), rho_3, color = color_rho[3], step="mid")
