...
plt.xlabel(r'Target marginal feeding rate ($\eta_m^*$)', fontsize = axes_font_size)
plt.ylabel(r'Average feeding rate ($\bar{\eta}$)', fontsize = axes_font_size)
plt.xticks(fontsize=graduation_font_size)
plt.yticks(fontsize=graduation_font_size)
plt.xlim([0,10.5])
plt.ylim([0,10.5])
